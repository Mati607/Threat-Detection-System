...
- **⚙️ Robust, end-to-end system**: from raw data parsing to evaluation and reporting
...
- **🗂️ Real-world datasets**: evaluated across multiple DARPA datasets and scenarios
...
- **🕸️ Advanced Graph Algorithms** - Weisfeiler-Lehman Hashing, Graph2Vec, Procrustes Analysis
- **🏗️ Production Infrastructure** - Docker, Elasticsearch, Parallel Processing
...
- ⚙️ Feature Engineering:
  ...
  - 🕸️ Graph-based representations (graph2vec) for structural patterns
- 🤖 Model Layer:
  - 🛠️ Configurable pipelines for centralized or federated training
  - 🛡️ Support for differential privacy training regimes
...
- **🗂️ Multi-Dataset Support**: Evaluation across DARPA OpTC, E3, and E5 datasets
